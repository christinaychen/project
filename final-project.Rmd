...
- Family composition (see Figure 1)
...
```{r fig.height = 4, fig.width = 7, fig.cap="Figure 1"}
# els %>%
...
- Percent of students with free lunch (see Figure 2)
